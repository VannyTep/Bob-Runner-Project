...
public class ParallexBackground : MonoBehaviour
{
    ...
    public float length = 0; // Make sure that to set your second copy gameobject parent background same as the x position of the second copy gameobject parent background
